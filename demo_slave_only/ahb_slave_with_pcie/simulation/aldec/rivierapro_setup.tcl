...
# ACDS 14.0 200 linux 2015.08.10.11:45:03
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_001 -L router -L crosser -L rsp_mux_002 -L rsp_demux_001 -L cmd_mux_001 -L cmd_demux_003 -L cmd_demux_002 -L router_005 -L router_004 -L router_002 -L sgdma_csr_rsp_width_adapter -L sgdma_csr_burst_adapter -L pcie_ip_bar2_limiter -L sgdma_csr_agent_rsp_fifo -L sgdma_csr_agent -L pcie_ip_bar2_agent -L sgdma_csr_translator -L pcie_ip_bar2_translator -L pipe_interface_internal -L reset_controller_internal -L altgx_internal -L pcie_internal_hip -L rst_controller -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L top_level_0 -L avalon2ahb_bridge_0 -L altpll_qsys -L sdram -L sgdma -L pcie_ip -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_001 -L router -L crosser -L rsp_mux_002 -L rsp_demux_001 -L cmd_mux_001 -L cmd_demux_003 -L cmd_demux_002 -L router_005 -L router_004 -L router_002 -L sgdma_csr_rsp_width_adapter -L sgdma_csr_burst_adapter -L pcie_ip_bar2_limiter -L sgdma_csr_agent_rsp_fifo -L sgdma_csr_agent -L pcie_ip_bar2_agent -L sgdma_csr_translator -L pcie_ip_bar2_translator -L pipe_interface_internal -L reset_controller_internal -L altgx_internal -L pcie_internal_hip -L rst_controller -L irq_mapper -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L top_level_0 -L avalon2ahb_bridge_0 -L altpll_qsys -L sdram -L sgdma -L pcie_ip -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}

// ahb_master_slave_with_pcie_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module ahb_master_slave_with_pcie_mm_interconnect_0 (
	...
	ahb_master_slave_with_pcie_mm_interconnect_0_router router (
	...
	ahb_master_slave_with_pcie_mm_interconnect_0_router_001 router_001 (
	...
	ahb_master_slave_with_pcie_mm_interconnect_0_router_001 router_002 (
	...
	ahb_master_slave_with_pcie_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pcie_ip_pcie_core_clk_clk),                                 //        clk.clk
		.reset              (pcie_ip_bar2_translator_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	ahb_master_slave_with_pcie_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pcie_ip_pcie_core_clk_clk),               //       clk.clk
		.reset               (sgdma_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_master_slave_with_pcie_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (pcie_ip_pcie_core_clk_clk),                                 //       clk.clk
		.reset               (pcie_ip_bar2_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_master_slave_with_pcie_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pcie_ip_pcie_core_clk_clk),                     //       clk.clk
		.reset              (sgdma_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
	...
	ahb_master_slave_with_pcie_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (pcie_ip_pcie_core_clk_clk),                                 //       clk.clk
		.reset              (pcie_ip_bar2_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ahb_master_slave_with_pcie_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pcie_ip_pcie_core_clk_clk),                                 //       clk.clk
		.reset               (pcie_ip_bar2_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset

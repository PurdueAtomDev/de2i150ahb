...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_2_rsp_mux.sv"       -work rsp_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_2_rsp_demux.sv"     -work rsp_demux                  
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                   -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_2_cmd_mux.sv"       -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_2_cmd_demux.sv"     -work cmd_demux                  
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_2_router_001.sv"    -work router_001                 
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_2_router.sv"        -work router                     
  ...
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_rsp_mux_004.sv"   -work rsp_mux_004                
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                   -work rsp_mux_002                
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_rsp_mux_002.sv"   -work rsp_mux_002                
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                   -work rsp_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_rsp_mux.sv"       -work rsp_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_rsp_demux_001.sv" -work rsp_demux_001              
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_rsp_demux.sv"     -work rsp_demux                  
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                   -work cmd_mux_001                
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_cmd_mux_001.sv"   -work cmd_mux_001                
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                   -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_cmd_mux.sv"       -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_cmd_demux_004.sv" -work cmd_demux_004              
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_cmd_demux_003.sv" -work cmd_demux_003              
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_cmd_demux_002.sv" -work cmd_demux_002              
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_cmd_demux.sv"     -work cmd_demux                  
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_router_006.sv"    -work router_006                 
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_router_005.sv"    -work router_005                 
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_router_004.sv"    -work router_004                 
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_router_002.sv"    -work router_002                 
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_1_router.sv"        -work router                     
  ...
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                   -work rsp_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_0_rsp_mux.sv"       -work rsp_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_0_rsp_demux.sv"     -work rsp_demux                  
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                   -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_0_cmd_mux.sv"       -work cmd_mux                    
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_0_cmd_demux.sv"     -work cmd_demux                  
  ...
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_0_router_001.sv"    -work router_001                 
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_mm_interconnect_0_router.sv"        -work router                     
  ...
  vlog  "$QSYS_SIMDIR/submodules/ahb_master_slave_with_pcie_irq_mapper.sv"                      -work irq_mapper                 
  ...
  vlog  "$QSYS_SIMDIR/submodules/ahb_avalon_bridge_with_burst.sv"                               -work ahb2avalon_burst_bridge_0  
  vlog  "$QSYS_SIMDIR/submodules/top_level.sv"                                                  -work ahb_master_slave_2_0       
